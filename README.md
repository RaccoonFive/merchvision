...
- **Item Lookup:** shows current quotes, net margin, warnings, and recent price history for a selected item.
...
3. Set the values in `.env`:
   ...
   | `BETTER_AUTH_URL` | The application origin, normally `http://localhost:3000` locally. |
...
| Command | Purpose |
| --- | --- |
| `npm run dev` | Start the Next.js development server using `.next-dev`. |
